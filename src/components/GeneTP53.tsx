  ...
  useEffect(() => {
    if (networkContainer.current) {
      ...
      const edges = new vis.DataSet([
        { arrows: "to", color: "#00ff00", from: "TP53", to: "CDKN1A", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "TP53", to: "CDKN2A", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "TP53", to: "CDKN2C", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "TP53", to: "CDKN1B", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "CASP8", to: "TP53", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "CASP8", to: "ATM", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "CASP8", to: "CASP3", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "CASP8", to: "BID", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "CASP8", to: "CASP7", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "CASP8", to: "CASP6", title: "activation" },
        { arrows: "to", color: "#ff0000", from: "MDM2", to: "TP53", title: "inhibition" },
        { arrows: "to", color: "#00ff00", from: "ATM", to: "TP53", title: "activation" },
        { arrows: "to", color: "#ff0000", from: "CDKN2A", to: "MDM2", title: "inhibition" },
        { arrows: "to", color: "#ff0000", from: "CDKN2A", to: "CDK4", title: "inhibition" },
        { arrows: "to", color: "#00ff00", from: "MYC", to: "CDKN2A", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "MAPK14", to: "CDKN2A", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "RRAS2", to: "CDKN2A", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "FADD", to: "CASP8", title: "activation" },
        { arrows: "to", color: "#ff0000", from: "CFLAR", to: "CASP8", title: "inhibition" },
        { arrows: "to", color: "#00ff00", from: "GZMB", to: "CASP8", title: "activation" },
      ]);
      ...
      const options = {
        ...
        physics: { enabled: true, stabilization: { enabled: true, fit: true, iterations: 1000 } },
        layout: { randomSeed: 2 },
      };
