  ...
  useEffect(() => {
    if (networkContainer.current) {
      ...
      const edges = new vis.DataSet([
        { arrows: "to", color: "#00ff00", from: "EGF", to: "EGFR", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EGFR", to: "SHC2", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EGFR", to: "PLCG1", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EGFR", to: "STAT5A", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EGFR", to: "CRK", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EGFR", to: "SRC", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EGFR", to: "GRB2", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "TGFA", to: "EGFR", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "AREG", to: "EGFR", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "BTC", to: "EGFR", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "BTC", to: "ERBB4", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "HBEGF", to: "EGFR", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "HBEGF", to: "ERBB4", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EREG", to: "EGFR", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "EREG", to: "ERBB4", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "SHC2", to: "GRB2", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "GRB2", to: "SOS1", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "GRB2", to: "GAB1", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "MMP2", to: "HBEGF", title: "activation" },
        { arrows: "to", color: "#00ff00", from: "MMP24", to: "HBEGF", title: "activation" },
      ]);
      ...
      const options = {
        ...
        physics: {
          ...
          barnesHut: { gravitationalConstant: -5000, centralGravity: 0.3, springLength: 100 },
        },
        manipulation: {
          enabled: false,
        },
